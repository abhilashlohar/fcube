...
<?php echo $this->Html->css('../assets/global/plugins/font-awesome/css/font-awesome.min'); ?>
<?php echo $this->Html->css('../assets/global/plugins/simple-line-icons/simple-line-icons.min'); ?>
<?php echo $this->Html->css('../assets/global/plugins/bootstrap/css/bootstrap.min'); ?>
<?php echo $this->Html->css('../assets/global/plugins/uniform/css/uniform.default'); ?>
<?php echo $this->Html->css('../assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min'); ?>
<?php echo $this->Html->css('../assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3'); ?>
<?php echo $this->Html->css('../assets/global/plugins/fullcalendar/fullcalendar.min'); ?>
<?php echo $this->Html->css('../assets/global/plugins/jqvmap/jqvmap/jqvmap'); ?>
<?php echo $this->Html->css('../assets/admin/pages/css/tasks'); ?>
<?php echo $this->Html->css('../assets/global/css/components'); ?>
<?php echo $this->Html->css('../assets/global/css/plugins'); ?>
<?php echo $this->Html->css('../assets/admin/layout/css/layout'); ?>
<?php echo $this->Html->css('../assets/admin/layout/css/themes/darkblue'); ?>
<?php echo $this->Html->css('../assets/admin/layout/css/custom'); ?>
<!-- END THEME STYLES -->
...
<![endif]-->
<?= $this->Html->script(['../assets/global/plugins/jquery.min','../assets/global/plugins/jquery-migrate.min']) ?>

<!-- IMPORTANT! Load jquery-ui-1.10.3.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
<?= $this->Html->script(['../assets/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min','../assets/global/plugins/bootstrap/js/bootstrap.min','../assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min','../assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min','../assets/global/plugins/jquery.blockui.min','../assets/global/plugins/jquery.cokie.min','../assets/global/plugins/uniform/jquery.uniform.min','../assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min','../assets/global/plugins/bootstrap-daterangepicker/moment.min','../assets/global/plugins/bootstrap-daterangepicker/daterangepicker','../assets/global/scripts/metronic','../assets/admin/layout/scripts/layout','../assets/admin/layout/scripts/quick-sidebar','../assets/admin/layout/scripts/demo','../assets/admin/pages/scripts/index','../assets/admin/pages/scripts/tasks']) ?>
