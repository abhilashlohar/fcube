...
<div class="users form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('parent_full_name');
            echo $this->Form->control('parent_contact_number');
            echo $this->Form->control('remark');
            echo $this->Form->control('epicenter');
            echo $this->Form->control('center');
            echo $this->Form->control('facebook');
            echo $this->Form->control('instagram');
            echo $this->Form->control('password');
            echo $this->Form->control('registration_location');
        ?>
    </fieldset>
